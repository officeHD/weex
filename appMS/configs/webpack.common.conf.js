...
const weexEntry = {
  ...
  'claims': helper.root('entry/ClaimsPage.js'),
  'count': helper.root('entry/CountPage.js'),
  'customer': helper.root('entry/CustomerPage.js'),
  'message': helper.root('entry/MessagePage.js'),
  'setting': helper.root('entry/SettingPage.js'),
  'team': helper.root('entry/TeamPage.js'),
  
  'order': helper.root('entry/OrderPage.js'),
  'userfile': helper.root('entry/UserFilePage.js')
}
